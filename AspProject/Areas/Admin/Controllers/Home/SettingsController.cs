...
namespace AspProject.Areas.Admin.Controllers.Home
{
    ...
    public class SettingsController : Controller
    {
        ...
        public SettingsController(AplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Address,Phone")] Setting setting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Address,Phone")] Setting setting)
        {
            if (id != setting.Id)
            {
                return NotFound();
